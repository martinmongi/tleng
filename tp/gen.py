...
if True:
    ...
    f.write('<line x1="0" y1="-100" x2="0" y2="100" stroke-width="0.02" stroke="black"/>\n')

    for i in range(1,101):
        f.write('<line x1="' + str(i) + '" y1="-100" x2="' +str(i) + '" y2="100" stroke-width="0.01" stroke="black"/>\n')
        f.write('<line x1="-100" y1="'+ str(i) + '" x2="100" y2="' + str(i) + '" stroke-width="0.01" stroke="black"/>\n')
